...
const whatsapplu = 'Wa.me/62812818726991'; // Nomor whatsapplu cok
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] RMS BOT Ready Scan Now!`);
});
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => BOT WhatsApp RMS`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => Bot WhatsApp RMS BOT`)
})
...
{
conn.sendMessage(id, 'pa pe pa pe assalamualikum jangan p punya agama kan eh btw jangan baperan aku kan bot hehe \n\n\n Ketik *!menu* Untuk Menu list Bot' ,MessageType.text);
}
else if (text == 'p')
{
conn.sendMessage(id, 'pa pe pa pe assalamualikum jangan p punya agama kan eh btw jangan baperan aku kan bot hehe \n\n\n Ketik *!menu* Untuk Menu List Bot' ,MessageType.text);
